...
const rustLines = execFileSync(paths.wasmtime, ["compile-run", paths.compiler, paths.profile, paths.pack, paths.lib, paths.main, paths.protoIdentity, "1", "alpha", "7", "beta", "-4", "gamma"], { encoding: "utf8" }).trim().split("\n");
const interpreterLines = execFileSync(paths.interpreter, [paths.lib, paths.main, paths.protoIdentity], { encoding: "utf8" }).trim().split("\n");
