...
pub fn validateContinuationRegion(
    ...
    _ = allocator;
    return context.plan.continuationAdmitted(continuation_block_id, suffix_start, block_finish) orelse false;
}
...
pub fn validateGenericIterationContinuationRegion(
    ...
    _ = allocator;
    return context.plan.iterationAdmitted(pattern.repeat_target, pattern.exit_target) orelse false;
}
